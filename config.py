...
APP_ID = int(os.environ.get("APP_ID", "11472991")) #Your API ID from my.telegram.org
API_HASH = os.environ.get("API_HASH", "c78c50d54baf2173e8b3f75c359c0c72") #Your API Hash from my.telegram.org
#--------------------------------------------
